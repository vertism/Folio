...
- (void)viewWillAppear:(BOOL)animated 
{
	...
	self.navigationItem.title = selectedTag.tagName;
...
- (void)loadItems
{
	...
	items = [[NSArray alloc] initWithArray:[[selectedTag.items allObjects] sortedArrayUsingDescriptors:sortDescriptors]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	addItem.selectedTag = [selectedTag retain];
...
- (void)tableView:(UITableView *)tabView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	{
		Item *currentItem = [items objectAtIndex:indexPath.row];
		[selectedTag removeItemsObject:currentItem];
